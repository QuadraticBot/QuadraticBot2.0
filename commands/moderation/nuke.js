import { SlashCommandBuilder, EmbedBuilder, PermissionsBitField, Embed, ChannelType } from "discord.js"
...
export default {
    ...
    .setDescription("You're lacking the permission to run that command")
    .setColor("5865f2")
